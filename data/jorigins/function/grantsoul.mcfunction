power revoke @s jorigins:sun/sunlight_resource jorigins:basevessel
power revoke @s jorigins:sun/normal jorigins:basevessel
...
power grant @s jorigins:soul/astralform jorigins:basevessel
power grant @s jorigins:soul/limited jorigins:basevessel
power grant @s jorigins:soul/movement jorigins:basevessel