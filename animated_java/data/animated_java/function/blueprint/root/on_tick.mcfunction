...
execute if entity @s[tag=aj.blueprint.animation.animation_model_idle.playing] run function animated_java:blueprint/animations/animation_model_idle/zzz/on_tick
